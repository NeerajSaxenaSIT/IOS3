                    ...
                    Using sheet As IXlSheet = document.CreateSheet()
                        ...
                        For Each drData As DataRow In dtData.Rows
                            ...
                            Using row As IXlRow = sheet.CreateRow()
                                ...
                                For Each dtCol As DataColumn In dtData.Columns
                                    Using cell As IXlCell = row.CreateCell()
                                        If dtCol.DataType.Name = "DateTime" Then
                                            cell.Value = CDate(drData(dtCol))
                                            cell.Formatting = New XlCellFormatting()
                                            cell.Formatting.NumberFormat = "dd/MM/yyyy hh:mm:ss"
                                        Else
                                            cell.Value = CStr(IIf(IsDBNull(drData(dtCol)), "", drData(dtCol)))
                                        End If
                                        cell.ApplyFormatting(cellFormatting)
                                    End Using
                                Next
