Public Class SQLTechnologyPackageObjects
    Inherits SQLCommanCommand
    Sub New()
        _tableName = ViewName.VIEW_TECHNOLOGY_PACKAGE_OBJECTS
    End Sub
    ...
    '    Return "Select * from " & DataBaseTableName.TBL_TECHNOLOGY_PACKAGE_OBJECTS_QRY
    'End Function
    ...
    '    Return SelectAll() & If(withAlias, " AS " & DataBaseTableName.TBL_TECHNOLOGY_PACKAGE_OBJECTS_QRY, "")
    'End Function
