Public Class SQLPredefinedPeriod
    Inherits SQLCommanCommand
    Sub New()
        _tableName = DataBaseTableName.TBL_PREDEFINED_PERIOD
    End Sub
    ...
    '    Return "Select * from " & DataBaseTableName.TBL_PREDEFINED_PERIOD
    'End Function
    ...
    '    Return SelectAll() & If(withAlias, " AS " & DataBaseTableName.TBL_PREDEFINED_PERIOD, "")
    'End Function
