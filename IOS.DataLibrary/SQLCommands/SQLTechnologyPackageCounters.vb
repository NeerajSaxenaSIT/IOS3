Public Class SQLTechnologyPackageCounters
    Inherits SQLCommanCommand
    Sub New()
        _tableName = ViewName.VIEW_TECHNOLOGY_PACKAGE_COUNTERS
    End Sub
    ...
    '    Return "Select * from " & DataBaseTableName.TBL_TECHNOLOGY_PACKAGE_COUNTERS_QRY
    'End Function
    ...
    '    Return SelectAll() & If(withAlias, " AS " & DataBaseTableName.TBL_TECHNOLOGY_PACKAGE_COUNTERS_QRY, "")
    'End Function
