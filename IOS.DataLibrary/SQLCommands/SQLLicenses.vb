Public Class SQLLicenses
    Inherits SQLCommanCommand
    Sub New()
        _tableName = DataBaseTableName.TBL_LICENSES
    End Sub
    ...
    '    Return "Select * from " & DataBaseTableName.TBL_LICENSES
    'End Function
    ...
    '    Return SelectAll() & If(withAlias, " AS " & DataBaseTableName.TBL_LICENSES, "")
    'End Function
