Public Class SQLTechnologyCounters
    Inherits SQLCommanCommand
    Sub New()
        _tableName = DataBaseTableName.TBL_TECHNOLOGY_COUNTERS
    End Sub
    ...
    '    Return "Select * from " & DataBaseTableName.TBL_TECHNOLOGY_COUNTERS
    'End Function
    ...
    '    Return SelectAll() & If(withAlias, " AS " & DataBaseTableName.TBL_TECHNOLOGY_COUNTERS, "")
    'End Function
