...
Public Class IOSChartManager
    ...
    Private _ListOfYAxis As New List(Of IOSAxis)

    Public Property ListOfYAxis() As List(Of IOSAxis)
        Get
            Return _ListOfYAxis
        End Get
        Set(ByVal value As List(Of IOSAxis))
            _ListOfYAxis = value
        End Set
    End Property
    Public Sub New(ByRef ChartControl As dotnetCHARTING.WinForms.Chart, ByRef ChartData As DataTable, ByRef ChartElements As List(Of String), ByRef ChartHeader As String, ByRef ListOfYAxis As List(Of IOSAxis))
    ...
    Public Sub CreateChartOnRSCPandEconCount(ByVal chartType As ChartType, ByVal DefaultseriesType As SeriesType, ByVal seriesType As SeriesType, ByVal size As Integer)
        Try
    ...
    End Sub
    Public Sub CreateChartOnTimeStamp(ByVal chartType As ChartType, ByVal DefaultseriesType As SeriesType, ByVal seriesType As SeriesType, ByVal size As Integer)
        Try
            Me._ChartControl.XAxis.TickLabelMode = TickLabelMode.Angled
            Me._ChartControl.XAxis.TickLabelAngle = 45
    ...
    End Function
    Private Sub GenerateChart(ByVal chartType As ChartType, ByVal DefaultseriesType As SeriesType, ByVal seriesType As SeriesType, ByVal size As Integer)
